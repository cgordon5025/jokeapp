...
namespace jokeapp.Controllers
{
    public class JokeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,JokeQuestion,JokeANswe")] Joke joke)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,JokeQuestion,JokeANswe")] Joke joke)
        {
            if (id != joke.ID)
            {
                return NotFound();
